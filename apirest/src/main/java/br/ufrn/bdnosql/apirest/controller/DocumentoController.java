...
public class DocumentoController {
    ...
    @GetMapping("/{collection}")
	public ResponseEntity<List<Object>> listarTodos(@PathVariable String collection, @RequestParam(required = false) String query) {

        List<Object> resultado =
                service.listarDocumentos(collection, query);
